              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input {...register("title", { required: true })} placeholder="e.g. Server Failure" data-testid="input-title" disabled={submitting} />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input {...register("department")} placeholder="e.g. IT" data-testid="input-department" disabled={submitting} />
                  </div>
                  <div className="space-y-2">
                    <Label>Estimated Cost</Label>
                    <Input {...register("cost")} placeholder="e.g. $500" data-testid="input-cost" disabled={submitting} />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label>Root Cause</Label>
                  <Input {...register("cause")} placeholder="e.g. Power Surge" data-testid="input-cause" disabled={submitting} />
                </div>

                <div className="space-y-2">
                  <Label>Description</Label>
                  <Textarea {...register("description")} className="min-h-[100px]" data-testid="textarea-description" disabled={submitting} />
                </div>
                ...
                <div className="flex justify-end gap-4 pt-4">
                  <Button type="button" variant="outline" onClick={() => setLocation("/issues")} disabled={submitting} data-testid="button-cancel">Cancel</Button>
                  <Button type="submit" className="bg-rose-600 hover:bg-rose-700" disabled={submitting || uploading} data-testid="button-submit">
